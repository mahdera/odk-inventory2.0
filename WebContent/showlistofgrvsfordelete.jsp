...
<%
	...
	String functionalityName = "grvManagement";
...
<form style="background:#eeeeee">
	<table border="1" width="100%">
		<tr>
			...
			<td>
				<input type="button" value="Show" onclick="showListOfGRVsForThisHealthPostForDelete(document.getElementById('slcthealthpost').value);"/>
