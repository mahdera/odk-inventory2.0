...
<%
	...
	String functionalityName = "orderManagement";
...
<form style="background:#eeeeee">
	<table border="0" width="100%">		
		<tr>
			...
			<td>
				<input type="button" value="Show" onclick="showListOfOrdersForThisHealthPostToDelete(document.getElementById('slcthealthpost').value);"/>
