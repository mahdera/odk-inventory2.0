					...
					if(relateOdkUser != null){
						...
						while(orderItr.hasNext()){
							...
							<tr>
								...
								<td>
									<a href="#.jsp" onclick="showOrderProcessPageForThisOrder('<%=order.get_uri() %>',<%=healthPostId %>);">Open Process Form</a>
									|
									<a href="#.jsp" onclick="hideOrderProcessPageForThisOrder('<%=order.get_uri() %>');">Hide Process Form</a>
								</td>							
							</tr>
							<%
