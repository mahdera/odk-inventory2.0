...
<div class="padding box"> 
				...
				<!-- Search --> 
					...
					<!-- <fieldset> 
						...
						<p><input type="text" size="17" name="txtsearchquery" id="txtsearchquery" class="input-text" />&nbsp;<input type="button" value="OK" class="input-submit-02" onclick="showSearchResult(document.getElementById('txtsearchquery').value);"/><br /> 
