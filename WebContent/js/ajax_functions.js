function performThisFunction(menuName) {	
	if (menuName == "adminFields") {
		...
		xmlhttp.open("GET", "hewmanagement.jsp", true);
		xmlhttp.send();
		...
		xmlhttp.open("GET", "ordermanagement.jsp", true);
		xmlhttp.send();
		...
		xmlhttp.open("GET", "grvmanagement.jsp", true);
		xmlhttp.send();
		...
		xmlhttp.open("GET", "givmanagement.jsp", true);
		xmlhttp.send();
		...
		xmlhttp.open("GET", "viewapprovedorders.jsp", true);
		xmlhttp.send();
		...
		xmlhttp.open("GET", "downloadsmanagement.jsp", true);
		xmlhttp.send();
		...
		xmlhttp.open("GET", "mothermanagement.jsp", true);
		xmlhttp.send();
		...
		xmlhttp.open("GET", "schedulemanagement.jsp", true);
		xmlhttp.send();
	}
}
...
function showReport(rpt){
	if(rpt == "contraceptiveConsumptionPattern"){
		if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera,
			// Safari
			xmlhttp = new XMLHttpRequest();
		} else {// code for IE6, IE5
		...
		xmlhttp.open("GET", "showcontraceptiveconsumptionpatternselectorbar.jsp", true);
		xmlhttp.send();
	}else if(rpt == "contraceptiveConsumptionPatternPercentage"){
		if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera,
			// Safari
			xmlhttp = new XMLHttpRequest();
		} else {// code for IE6, IE5
		...
		xmlhttp.open("GET", "showcontraceptiveconsumptionpatternpercentageselectorbar.jsp", true);
		xmlhttp.send();
	}else if(rpt == "stockOutReport"){
		if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera,
			// Safari
			xmlhttp = new XMLHttpRequest();
		} else {// code for IE6, IE5
		...
		xmlhttp.open("GET", "showstockoutselectorbar.jsp", true);
		xmlhttp.send();
	}else if(rpt == "contraceptiveConsumptionPatternForAllHealthPosts"){
		if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera,
			// Safari
			xmlhttp = new XMLHttpRequest();
		} else {// code for IE6, IE5
		...
		xmlhttp.open("GET", "showcontraceptiveconsumptionpatternforallhealthpostsselectorbar.jsp", true);
		xmlhttp.send();
	}else if(rpt == "contraceptiveReceivePatternForAllHealthPosts"){
		if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera,
			// Safari
			xmlhttp = new XMLHttpRequest();
		} else {// code for IE6, IE5
		...
		xmlhttp.open("GET", "showcontraceptivereceivepatternforallhealthpostsselectorbar.jsp", true);
		xmlhttp.send();
	}else if(rpt == "contraceptiveOrderPatternForAllHealthPosts"){
		if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera,
			// Safari
			xmlhttp = new XMLHttpRequest();
		} else {// code for IE6, IE5
		...
		xmlhttp.open("GET", "showcontraceptiveorderpatternforallhealthpostsselectorbar.jsp", true);
		xmlhttp.send();
	}else if(rpt == "contraceptiveLostOrDamagePatternForAllHealthPosts"){
		if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera,
			// Safari
			xmlhttp = new XMLHttpRequest();
		} else {// code for IE6, IE5
		...
		xmlhttp.open("GET", "showcontraceptivelostordamagedpatternforallhealthpostsselectorbar.jsp", true);
		xmlhttp.send();
	}
}
